...
public class Lancamento {
	...
	@Override public boolean equals(Object o) {
		...
		return id.equals(that.id) && descricao.equals(that.descricao) && mes.equals(that.mes) && ano.equals(
				that.ano) && usuario.equals(that.usuario) && valor.equals(that.valor) && dataCadastro.equals(
				that.dataCadastro) && tipo == that.tipo && status == that.status;
	}
